package cn.edu.cquet.framework.aspectj;
...
import cn.edu.cquet.framework.security.context.PermissionContextHolder;
...
public class DataScopeAspect
{
    ...
    public static void dataScopeFilter(JoinPoint joinPoint, SysUser user, String deptAlias, String userAlias, String permission)
    {
        ...
        if (StringUtils.isNotBlank(sqlString.toString()))
        {
            ...
            if (StringUtils.isNotNull(params) && params instanceof AbsEntity)
            {
                AbsEntity baseEntity = (AbsEntity) params;
