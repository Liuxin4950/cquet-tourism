...
INSERT INTO `sys_menu` VALUES (2073, '新闻管理', 2072, 0, 'tourism', 'tourism/news/index', '', '', 1, 0, 'C', '0', '0', 'tourism:news:list', 'date-range', 'admin', '2025-11-03 14:24:01', 'admin', '2025-11-03 14:30:30', '', 0);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', 'CQUET', '00', 'CQUET@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2025-11-09 22:08:55', 'admin', '2024-09-04 06:22:51', NULL, '2025-11-09 22:08:55', '管理员');
...
INSERT INTO `sys_user` VALUES (105, NULL, 'liyuan', 'liyuan', '00', '', '', '0', '', '$2a$10$tgq/ctqpuY/moLaKttk/peQyxTfsy1X7nRW3MVYNCZYIuNvbqfVGK', '0', '0', '127.0.0.1', '2025-11-09 22:13:24', NULL, '2025-10-27 15:12:23', NULL, '2025-11-09 22:13:24', NULL);
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '特色活动信息表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '特色活动报名表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `tourism_news`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '旅游项目表' ROW_FORMAT = Dynamic;
...
INSERT INTO `tourism_news` VALUES (3, '测试标题003', '测试内容003', '测试作者003', '2025-10-29 10:41:46', 'liyuan', NULL, NULL, 0, NULL, NULL);
...
CREATE TABLE `tourism_scenic_spot`  (
  ...
  `image_urls` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '景区图片URLs，JSON格式存储',
  ...
  INDEX `idx_status`(`status` ASC) USING BTREE,
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 19 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'A级景区信息表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of tourism_scenic_spot
-- ----------------------------
INSERT INTO `tourism_scenic_spot` VALUES (1, '洪崖洞民俗风貌区', 'AAAA', '/images/hongyadong_cover.jpg', '[\"/images/hongyadong_1.jpg\",\"/images/hongyadong_2.jpg\"]', 0.00, '重庆市渝中区嘉陵江滨江路88号', '重庆市', '渝中区', '全天开放', '023-63039995', 'http://www.hongyadong.com', '洪崖洞是重庆市核心商圈解放碑的延伸，位于重庆市渝中区嘉陵江滨江路88号，是兼具观光旅游、休闲度假等功能的旅游区。', 106.5849700, 29.5642700, 0, 0, '0', 'admin', '2025-11-02 12:19:13', '', NULL, '重庆地标性景区', '0');
INSERT INTO `tourism_scenic_spot` VALUES (2, '磁器口古镇', 'AAAA', '/images/ciqikou_cover.jpg', '[\"/images/ciqikou_1.jpg\",\"/images/ciqikou_2.jpg\"]', 0.00, '重庆市沙坪坝区磁器口古镇', '重庆市', '沙坪坝区', '09:00-18:00', '023-65312003', '', '磁器口古镇位于重庆市沙坪坝区嘉陵江畔，始建于宋代，拥有\"一江两溪三山四街\"的独特地貌。', 106.4634200, 29.5906500, 0, 0, '0', 'admin', '2025-11-02 12:19:13', '', NULL, '千年古镇', '0');
INSERT INTO `tourism_scenic_spot` VALUES (3, '张家界国家森林公园', 'AAAAA', 'https://example.com/zhangjiajie.jpg', NULL, 248.00, '湖南省张家界市武陵源区', '张家界市', '', '07:00-18:00', '0744-5712189', '', '世界自然遗产，以奇峰异石著称，是电影《阿凡达》取景地', NULL, NULL, 0, 0, '1', 'admin', '2025-11-09 13:58:43', 'admin', '2025-11-09 13:58:43', NULL, '0');
INSERT INTO `tourism_scenic_spot` VALUES (4, '九寨沟风景区', 'AAAAA', 'https://example.com/jiuzhaigou.jpg', NULL, 169.00, '四川省阿坝州九寨沟县', '阿坝藏族羌族自治州', '', '08:00-17:00', '0837-7739753', '', '世界自然遗产，以彩池、雪峰、彩林、瀑布闻名，被誉为\"童话世界\"', NULL, NULL, 0, 0, '1', 'admin', '2025-11-09 13:58:43', 'admin', '2025-11-09 13:58:43', NULL, '0');
INSERT INTO `tourism_scenic_spot` VALUES (5, '黄山风景区', 'AAAAA', 'https://example.com/huangshan.jpg', NULL, 190.00, '安徽省黄山市黄山区', '黄山市', '', '06:30-17:30', '0559-5561111', '', '世界文化与自然双重遗产，以奇松、怪石、云海、温泉著称', NULL, NULL, 0, 0, '1', 'admin', '2025-11-09 13:58:43', 'admin', '2025-11-09 13:58:43', NULL, '0');
INSERT INTO `tourism_scenic_spot` VALUES (6, '泰山风景区', 'AAAAA', 'https://example.com/taishan.jpg', NULL, 115.00, '山东省泰安市泰山区', '泰安市', '', '06:00-17:30', '0538-8066606', '', '世界文化与自然双重遗产，五岳之首，历代帝王封禅之地', NULL, NULL, 0, 0, '1', 'admin', '2025-11-09 13:58:43', 'admin', '2025-11-09 13:58:43', NULL, '0');
INSERT INTO `tourism_scenic_spot` VALUES (7, '华山风景区', 'AAAAA', 'https://example.com/huashan.jpg', NULL, 160.00, '陕西省渭南市华阴市', '渭南市', '', '07:00-19:00', '0913-4362691', '', '五岳之一，以险峻著称，有\"奇险天下第一山\"之称', NULL, NULL, 0, 0, '1', 'admin', '2025-11-09 13:58:43', 'admin', '2025-11-09 13:58:43', NULL, '0');
INSERT INTO `tourism_scenic_spot` VALUES (8, '西湖风景区', 'AAAAA', 'https://example.com/xihu.jpg', NULL, 0.00, '浙江省杭州市西湖区', '杭州市', '', '全天开放', '0571-87179617', '', '世界文化遗产，江南名湖，有\"西湖十景\"著称', NULL, NULL, 0, 0, '1', 'admin', '2025-11-09 13:58:57', 'admin', '2025-11-09 13:58:57', NULL, '0');
INSERT INTO `tourism_scenic_spot` VALUES (9, '故宫博物院', 'AAAAA', 'https://example.com/gugong.jpg', NULL, 60.00, '北京市东城区景山前街4号', '北京市', '', '08:30-17:00', '010-85007421', '', '世界文化遗产，明清两代皇宫，世界最大的古代宫殿建筑群', NULL, NULL, 0, 0, '1', 'admin', '2025-11-09 13:58:57', 'admin', '2025-11-09 13:58:57', NULL, '0');
INSERT INTO `tourism_scenic_spot` VALUES (10, '天安门广场', 'AAAA', 'https://example.com/tiananmen.jpg', NULL, 0.00, '北京市东城区', '北京市', '', '全天开放', '010-65132225', '', '国家象征，人民广场，世界最大的城市广场之一', NULL, NULL, 0, 0, '1', 'admin', '2025-11-09 13:58:57', 'admin', '2025-11-09 13:58:57', NULL, '0');
INSERT INTO `tourism_scenic_spot` VALUES (11, '八达岭长城', 'AAAAA', 'https://example.com/changcheng.jpg', NULL, 40.00, '北京市延庆区八达岭镇', '北京市', '', '06:30-19:00', '010-69121226', '', '世界文化遗产，万里长城精华段，有\"不到长城非好汉\"之说', NULL, NULL, 0, 0, '1', 'admin', '2025-11-09 13:58:57', 'admin', '2025-11-09 13:58:57', NULL, '0');
INSERT INTO `tourism_scenic_spot` VALUES (12, '颐和园', 'AAAAA', 'https://example.com/yiheyuan.jpg', NULL, 30.00, '北京市海淀区新建宫门路19号', '北京市', '', '06:30-18:00', '010-62881144', '', '世界文化遗产，中国古典皇家园林的代表作', NULL, NULL, 0, 0, '1', 'admin', '2025-11-09 13:58:57', 'admin', '2025-11-09 13:58:57', NULL, '0');
INSERT INTO `tourism_scenic_spot` VALUES (13, '天坛公园', 'AAAAA', 'https://example.com/tiantan.jpg', NULL, 15.00, '北京市东城区天坛路甲1号', '北京市', '', '06:00-22:00', '010-67028866', '', '世界文化遗产，明清两代皇帝祭天、祈谷的圣地', NULL, NULL, 0, 0, '1', 'admin', '2025-11-09 13:59:20', 'admin', '2025-11-09 13:59:20', NULL, '0');
INSERT INTO `tourism_scenic_spot` VALUES (14, '明十三陵', 'AAAAA', 'https://example.com/shisanling.jpg', NULL, 45.00, '北京市昌平区十三陵镇', '北京市', '', '08:30-17:00', '010-60761424', '', '世界文化遗产，明朝十三位皇帝的陵寝', NULL, NULL, 0, 0, '1', 'admin', '2025-11-09 13:59:20', 'admin', '2025-11-09 13:59:20', NULL, '0');
INSERT INTO `tourism_scenic_spot` VALUES (15, '慕田峪长城', 'AAAAA', 'https://example.com/mutianyu.jpg', NULL, 45.00, '北京市怀柔区渤海镇慕田峪村', '北京市', '', '07:30-18:00', '010-61626022', '', '世界文化遗产，万里长城的重要关隘', NULL, NULL, 0, 0, '1', 'admin', '2025-11-09 13:59:20', 'admin', '2025-11-09 13:59:20', NULL, '0');
INSERT INTO `tourism_scenic_spot` VALUES (16, '司马台长城', 'AAAAA', 'https://example.com/simatai.jpg', NULL, 40.00, '北京市密云区古北口镇', '北京市', '', '08:00-17:00', '010-68347678', '', '世界文化遗产，长城保存最完整的一段', NULL, NULL, 0, 0, '1', 'admin', '2025-11-09 13:59:20', 'admin', '2025-11-09 13:59:20', NULL, '0');
INSERT INTO `tourism_scenic_spot` VALUES (17, '圆明园', 'AAAA', 'https://example.com/yuanmingyuan.jpg', NULL, 10.00, '北京市海淀区清华西路28号', '北京市', '', '07:00-19:30', '010-62628501', '', '清朝皇家园林遗址，万园之园', NULL, NULL, 0, 0, '1', 'admin', '2025-11-09 13:59:20', 'admin', '2025-11-09 13:59:20', NULL, '0');
INSERT INTO `tourism_scenic_spot` VALUES (18, '九寨沟风景', '4A', '', NULL, 169.00, '四川省阿坝藏族羌族自治州九寨沟县', '阿坝州', '九寨沟县', '08:00-18:00', '', '', '九寨沟是世界自然遗产、国家重点风景名胜区、国家AAAAA级旅游景区、国家级自然保护区、国家地质公园、世界生物圈保护区网络，是中国第一个以保护自然风景为主要目的的自然保护区。', 103.9180000, 33.2540000, 0, 0, '0', 'liyuan', '2025-11-09 22:18:33', 'liyuan', '2025-11-09 22:20:37', NULL, '2');
...
CREATE TABLE `tourism_user_collection`  (
  ...
  `target_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '收藏目标名称',
  `create_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
...
CREATE TABLE `tourism_venue`  (
  ...
  `cover_image` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '封面图片URL',
  `image_urls` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '场馆图片URLs，JSON格式存储',
  ...
  `facilities` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '设施信息，JSON格式存储',
