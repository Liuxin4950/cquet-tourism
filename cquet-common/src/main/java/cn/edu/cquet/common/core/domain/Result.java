package cn.edu.cquet.common.core.domain;
...
public class Result extends HashMap<String, Object>
{
    ...
    public Result()
    {
        ...
        super.put(MSG_TAG, "success");
        // 请求成功与否
        super.put(STATE, true);
        // 返回信息
        // 响应时间，毫秒
        super.put(TIME, System.currentTimeMillis());
        // 是否有更多
        super.put(MORE, false);
        //请求结果
    ...
    public Result putMeta(Object value) {
        super.put("meta", value);
        return this;
    }
