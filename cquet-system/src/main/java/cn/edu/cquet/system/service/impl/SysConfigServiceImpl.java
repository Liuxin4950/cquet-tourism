...
import cn.edu.cquet.common.annotation.DataSource;
...
import cn.edu.cquet.common.enums.DataSourceType;
...
import cn.edu.cquet.system.mapper.SysConfigMapper;
...
public class SysConfigServiceImpl extends ServiceImpl<SysConfigMapper, SysConfig> implements ISysConfigService {
    ...
    public int updateConfig(SysConfig config) {
        SysConfig temp = this.baseMapper.selectById(config.getConfigId());
