...
) ENGINE=InnoDB AUTO_INCREMENT=88 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=154 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tourism_activity` VALUES (1,'测试001','1','文化体验',1,'测试001','12344556677','2025-11-16 16:52:45','2025-11-15 16:52:48','2025-11-15 16:52:53','2025-11-15 16:52:54',0,0,0.00,NULL,NULL,0,0,'1','0','','',NULL,'',NULL,'admin','2025-11-15 17:32:48',NULL,'0'),(7,'重庆非遗展览季','https://cdn.example.com/images/feiyi-expo.jpg','展览',1,'重庆市文化和旅游委员会','13800138000','2025-12-01 09:00:00','2025-12-15 17:30:00',NULL,NULL,0,0,0.00,'集中展示川渝地区非遗项目与工艺，含互动体验。',NULL,0,0,'0','0','','',NULL,'admin','2025-11-15 17:58:32','',NULL,'','0'),(8,'重庆非遗展览季','https://cdn.example.com/images/feiyi-expo.jpg','展览',1,'重庆市文化和旅游委员会','13800138000','2025-12-01 09:00:00','2025-12-15 17:30:00',NULL,NULL,0,0,0.00,'集中展示川渝地区非遗项目与工艺，含互动体验。',NULL,0,0,'0','0','','',NULL,'admin','2025-11-15 17:58:34','',NULL,'','0');
...
CREATE TABLE `tourism_image` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='旅游图片信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tourism_image` VALUES (1,'1.jpg'),(2,'2.jpg'),(3,'1.jpg'),(4,'2.jpg'),(5,'3.jpg');
...
-- Dump completed on 2025-11-16 22:47:57
